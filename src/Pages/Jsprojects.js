            ...
            <div className="js">
              <div className="row">
                <div className="col-sm-6">
                  <a
                    href="https://Cadburyash.github.io/"
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <a
                    ...
                    rel="noreferrer"
                  >
                    Github Code <img src={githubImg} alt="githubimg"/>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="js">
              <div className="row">
                <div className="col-sm-6">
                  ...
                  <br />
                  <a
                    href="https://github.com/Cadburyash/shoplane"
                    className="btn btn-default d-block github"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                <div className="col-sm-6">
                  <a
                    href="https://Cadburyash.github.io/project/"
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <a
                    href="https://github.com/Cadburyash/project"
                    className="btn btn-default d-block github"
                    target="_blank"
                    rel="noreferrer"
                  >
